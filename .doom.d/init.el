...
(doom! :input
       ...
       (javascript +lsp +typescript) ; for Typescript run: npm install -g typescript-language-server typescript
       ...
       (rust +lsp); for rust run: rustup component add rust-analyzer rust-src 
       ;;scala             ; java, but good
